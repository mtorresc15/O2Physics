...
struct HfCandidateSelectorToOmegaPiQa {
  ...
  void runOmegac0Selector(TCandTable const& candidates, TracksSel const&)
  {
    ...
    for (const auto& candidate : candidates) {
      ...
      auto trackKaFromCasc = candidate.template bachelor_as<TracksSel>();
  ...
  ///////////////////////////////////
  void processOmegac0SelectorWithDCAFitter(aod::HfCandToOmegaPi const& candidates, TracksSel const& tracks)
  {
    runOmegac0Selector<false>(candidates, tracks);
  }
  ...
  ////////////////////////////////////
  void processOmegac0SelectorWithKFParticle(soa::Join<aod::HfCandToOmegaPi, aod::HfOmegacKf> const& candidates, TracksSel const& tracks)
  {
    runOmegac0Selector<true>(candidates, tracks);
  }
